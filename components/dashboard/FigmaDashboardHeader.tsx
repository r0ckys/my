...
const FigmaDashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  return (
    <div className="w-full bg-white border-b border-gray-100 px-3 sm:px-4 md:px-5 lg:px-6 py-2 sm:py-3 md:py-4">
      <div className="flex items-center justify-between gap-2 sm:gap-3 md:gap-4 flex-wrap lg:flex-nowrap">
        {/* Welcome Section */}
        <div className="flex-shrink-0 min-w-0">
          <h1 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 truncate" style={{ fontFamily: 'Poppins, sans-serif' }}>
            Welcome back, {user?.name || 'Yuvraj'}
          </h1>
          <p className="text-xs sm:text-sm text-gray-500 mt-0.5 sm:mt-1 hidden xs:block" style={{ fontFamily: 'Poppins, sans-serif' }}>
            Monitor your business analytics and statistics.
          </p>
        </div>

        {/* Action Buttons */}
        <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 flex-wrap lg:flex-nowrap">
          {/* View Website Button */}
          <a
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium hidden xs:inline" style={{ fontFamily: 'Poppins, sans-serif' }}>View Website</span>
          </a>
          ...
          <button className="flex items-center gap-1 sm:gap-2 bg-gray-100 text-gray-700 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-md sm:rounded-lg hover:bg-gray-200 transition-colors">
            ...
            <span className="text-xs sm:text-sm font-medium hidden sm:inline" style={{ fontFamily: 'Poppins, sans-serif' }}>Tutorials</span>
          </button>
          ...
          <div className="relative hidden md:flex items-center bg-gray-50 rounded-md sm:rounded-lg px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 w-40 lg:w-64 xl:w-72 border border-gray-100">
            ...
            <input
              ...
              className="bg-transparent flex-1 text-xs sm:text-sm text-gray-700 placeholder-gray-400 focus:outline-none"
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 md:gap-3 ml-1 sm:ml-2 pl-2 sm:pl-3 md:pl-4 border-l border-gray-200">
            <div className="text-right hidden sm:block">
              <div className="text-[10px] sm:text-xs text-gray-400" style={{ fontFamily: 'Poppins, sans-serif' }}>Admin</div>
              <div className="text-xs sm:text-sm font-medium text-gray-900 truncate max-w-[60px] sm:max-w-[80px] md:max-w-none" style={{ fontFamily: 'Poppins, sans-serif' }}>{user?.name || 'Yuvraj'}</div>
            </div>
